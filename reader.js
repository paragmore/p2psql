...
import b4a from "b4a";
const DATABASE_KEY = "my-p2p-database";

const store = new Corestore("./reader-storage");

const swarm = new Hyperswarm();
swarm.join(DATABASE_KEY, {
  announce: true, // Allow other peers to discover this node
  lookup: true, // Look for other peers in the network
});
